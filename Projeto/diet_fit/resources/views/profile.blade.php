...
<div class="py-2">
    ...
    <div class="max-w-4xl mx-auto bg-white py-6 px-12 rounded-lg shadow-2xl">
        ...
        <div>
            ...
            transition duration-150 ease-in-out">Editar</button>
            </div>
        </div>
    </div>
